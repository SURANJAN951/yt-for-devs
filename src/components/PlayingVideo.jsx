...
const PlayingVideo = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-100">
      {/* Video Section */}
      <div className={`flex-1 p-4 bg-white overflow-y-auto ${showCodeEditor || showNotepad ? 'mb-1/3' : ''}`}>
        <h1 className="text-2xl font-semibold mb-4">Playing Video</h1>
        <div className="relative">
          <iframe
            width="100%"
            height={showCodeEditor || showNotepad ? "400px" : "600px"}
